 ...
 *
 * Definitions needed to make Lustre kernel code compile
 * in userspace.
 *
...
#define BUILD_BUG_ON(input) _Static_assert(!(input), #input)
#define target_supports_large_nid(mti) 1
...
#define LASSERT(statement)
#define LASSERTF(statement, ...)

#define max_t(type, arg1, arg2) (arg1 > arg2 ? arg1 : arg2)
