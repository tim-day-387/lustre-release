...
static const struct lnet_debugfs_symlink_def lnet_debugfs_symlinks[] = {
	{ .name		= "console_ratelimit",
	  .target	= "../../../module/lnet/parameters/libcfs_console_ratelimit" },
	{ .name		= "debug_path",
	  .target	= "../../../module/lnet/parameters/libcfs_debug_file_path" },
	{ .name		= "panic_on_lbug",
	  .target	= "../../../module/lnet/parameters/libcfs_panic_on_lbug" },
	{ .name		= "console_backoff",
	  .target	= "../../../module/lnet/parameters/libcfs_console_backoff" },
	{ .name		= "debug_mb",
	  .target	= "../../../module/lnet/parameters/libcfs_debug_mb" },
	{ .name		= "console_min_delay_centisecs",
	  .target	= "../../../module/lnet/parameters/libcfs_console_min_delay" },
	{ .name		= "console_max_delay_centisecs",
	  .target	= "../../../module/lnet/parameters/libcfs_console_max_delay" },
	{ .name		= "cpu_npartitions",
	  .target	= "../../../module/lnet/parameters/cpu_npartitions" },
	{ .name		= NULL },
};
...
int libcfs_setup(void)
{
	...
	lnet_insert_debugfs(debug_table, THIS_MODULE, &debugfs_state);
	if (!IS_ERR_OR_NULL(lnet_debugfs_root))
